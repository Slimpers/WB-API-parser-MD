...
**Полный путь:** `GET /api/v1/feedbacks`
...
|---|---|---|---|---|
| `isAnswered` | query | boolean; пример: `False` | да | Обработан ли отзыв:   - `true` — да   - `false` — нет |
| `nmId` | query | integer; пример: `5870243` | нет | Артикул WB |
| `take` | query | integer; пример: `1` | да | Количество отзывов (max. 5 000) |
| `skip` | query | integer; пример: `0` | да | Количество отзывов для пропуска (max. 199990) |
