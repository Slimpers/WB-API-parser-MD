...
**Полный путь:** `GET /api/v1/questions/count`

## Описание

<span>Описание метода</span>

Метод возвращает количество отвеченных или неотвеченных [вопросов](./user-communication#tag/Voprosy/paths/~1api~1v1~1questions/get) за заданный период.
...
| `isAnswered` | query | boolean; пример: `False` | нет | Есть ли ответ на вопрос:   - `true` — да   - `false` — нет |
...
- `data` — integer; пример: `77`. Количество вопросов
