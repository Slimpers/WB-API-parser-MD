...
`operationId`: getCommonV1Rating  
теги: `Информация о продавце`

**Полный путь:** `GET /api/common/v1/rating`
...
- `feedbackCount` — integer; пример: `12355`. Количество отзывов
- `valuation` — number (float); пример: `4.55`. Рейтинг продавца
