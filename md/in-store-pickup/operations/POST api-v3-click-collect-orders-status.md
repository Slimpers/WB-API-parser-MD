...
**Полный путь:** `POST https://marketplace-api.wildberries.ru/api/v3/click-collect/orders/status`
...
- `orders` — array<$ref: api.OrderStatus>. Список статусов сборочных заданий
