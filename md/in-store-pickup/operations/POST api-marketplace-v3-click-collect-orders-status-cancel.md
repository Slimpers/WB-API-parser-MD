...
**Отменить сборочные задания{{ /api/marketplace/v3/click-collect/orders/status/cancel }}**

теги: `Сборочные задания Самовывоз`

**Базовый URL:** `https://marketplace-api.wildberries.ru`

**Полный путь:** `POST https://marketplace-api.wildberries.ru/api/marketplace/v3/click-collect/orders/status/cancel`
