...
**Полный путь:** `DELETE https://marketplace-api.wildberries.ru/api/v3/click-collect/orders/{orderId}/meta`
...
| `key` | query | string | да | Название метаданных для удаления (`imei`, `uin`, `gtin`, `sgtin`). Передается только одно значение. |
