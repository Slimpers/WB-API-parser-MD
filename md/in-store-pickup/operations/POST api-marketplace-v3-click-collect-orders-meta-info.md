...
**Получить метаданные сборочных заданий{{ /api/marketplace/v3/click-collect/orders/meta/info }}**

теги: `Метаданные Самовывоз`

**Базовый URL:** `https://marketplace-api.wildberries.ru`

**Полный путь:** `POST https://marketplace-api.wildberries.ru/api/marketplace/v3/click-collect/orders/meta/info`
...
- `meta` **(required)** — array<$ref: api.OrderMetaV2>. Метаданные сборочных заданий
