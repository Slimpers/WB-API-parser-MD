...
**Полный путь:** `DELETE /api/v3/dbw/orders/{orderId}/meta`
...
|---|---|---|---|---|
| `` |  |  | нет |  |
| `key` | query | string | нет | Название метаданных для удаления (`imei`, `uin`, `gtin`, `sgtin`). Передаётся только одно значение |
