...
**Полный путь:** `PUT /api/v3/dbw/orders/{orderId}/meta/imei`

## Описание

<div class='description-title'><span>Описание метода</span></div>

Метод обновляет IMEI в [метаданных сборочного задания](./orders-dbw#tag/Metadannye-DBW/paths/~1api~1marketplace~1v3~1dbw~1orders~1meta~1details/post).
<br><br>
