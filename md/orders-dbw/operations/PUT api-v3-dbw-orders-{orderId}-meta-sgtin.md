...
**Полный путь:** `PUT /api/v3/dbw/orders/{orderId}/meta/sgtin`
...
- `sgtins` — array<string; пример: `1234567890123456`>. Массив кодов маркировки Честного знака. Допускается от 16 до 135 символов для кода одной маркировки
