...
**Полный путь:** `PATCH /api/v3/dbw/orders/{orderId}/confirm`

## Описание

<div class='description-title'><span>Описание метода</span></div>

Метод переводит [сборочное задание](./orders-dbw#tag/Sborochnye-zadaniya-DBW) в [статус](./orders-dbw#tag/Sborochnye-zadaniya-DBW/paths/~1api~1v3~1dbw~1orders~1status/post) `confirm` — на сборке.
