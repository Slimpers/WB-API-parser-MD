...
**Полный путь:** `PUT /api/v3/dbw/orders/{orderId}/meta/gtin`

## Описание

<div class='description-title'><span>Описание метода</span></div>

Метод обновляет GTIN в [метаданных сборочного задания](./orders-dbw#tag/Metadannye-DBW/paths/~1api~1marketplace~1v3~1dbw~1orders~1meta~1details/post) — уникальный ID товара в Беларуси.
<br><br>
...
- `gtin` **(required)** — string; пример: `1234567890123`. GTIN
