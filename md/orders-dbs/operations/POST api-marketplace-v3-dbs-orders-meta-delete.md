...
**Полный путь:** `POST /api/marketplace/v3/dbs/orders/meta/delete`

## Описание

<span>Описание метода</span>

Метод удаляет значение указанных [метаданных](./orders-dbs#tag/Metadannye-DBS/paths/~1api~1marketplace~1v3~1dbs~1orders~1meta~1details/post) для нескольких сборочных заданий.
...
В одном запросе можно удалить метаданные только одного типа. Укажите тип метаданных в запросе:
  ...
  - `gtin` — [GTIN](./orders-dbs#tag/Metadannye-DBS/paths/~1api~1marketplace~1v3~1dbs~1orders~1meta~1gtin/post)
...
- `key` **(required)** — string; пример: `imei`. Название метаданных для удаления (**imei**, **uin**, **gtin**, **sgtin**). Передаётся только одно значение
- `orderIds` **(required)** — array<integer>. Список ID сборочных заданий
