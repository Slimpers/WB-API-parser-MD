...
**Полный путь:** `POST /api/v3/supplies/{supplyId}/trbx`
...
- `amount` **(required)** — integer; пример: `4`. Количество грузомест, которые необходимо добавить к поставке
...
- `trbxIds` — array<string; пример: `WB-TRBX-1234567`>. Список ID грузомест, которые были созданы
