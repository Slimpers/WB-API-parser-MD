...
**Полный путь:** `POST /api/v3/passes`
...
- `firstName` **(required)** — string; пример: `Александр`. Имя водителя
- `lastName` **(required)** — string; пример: `Петров`. Фамилия водителя
- `carModel` **(required)** — string; пример: `Lamborghini`. Марка машины
- `carNumber` **(required)** — string; пример: `A456BC123`. Номер машины
- `officeId` **(required)** — integer (int64); пример: `15`. ID склада
...
- `id` — integer; пример: `2`. ID пропуска продавца
