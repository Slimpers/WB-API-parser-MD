...
**Полный путь:** `POST /api/v3/supplies/{supplyId}/trbx/stickers`
...
- `trbxIds` **(required)** — array<string; пример: `WB-TRBX-1234567`>. Список ID грузомест, по которым необходимо вернуть стикеры
...
- `stickers` — array<$ref: TrbxStickers>
