...
**Полный путь:** `GET /api/v3/supplies/{supplyId}/barcode`
...
- `barcode` — string; пример: `WB-GI-12345678`. Закодированное значение стикера (ID поставки)
- `file` — string (byte); пример: `U3dhZ2dlciByb2Nrcw==`. Полное представление стикера в заданном формате (кодировка base64)
