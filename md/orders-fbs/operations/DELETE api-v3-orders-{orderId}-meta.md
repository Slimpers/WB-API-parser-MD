...
**Полный путь:** `DELETE /api/v3/orders/{orderId}/meta`
...
Возможные метаданные:
  ...
  - `gtin` — [GTIN](/openapi/orders-fbs#tag/Metadannye-FBS/paths/~1api~1v3~1orders~1%7BorderId%7D~1meta~1gtin/put)
  - `sgtin` — [код маркировки Честного знака](/openapi/orders-fbs#tag/Metadannye-FBS/paths/~1api~1v3~1orders~1%7BorderId%7D~1meta~1sgtin/put)
...
|---|---|---|---|---|
| `` |  |  | нет |  |
| `key` | query | string | нет | Название метаданных для удаления (`imei`, `uin`, `gtin`, `sgtin`, `customsDeclaration`). Передается только одно значение. |
