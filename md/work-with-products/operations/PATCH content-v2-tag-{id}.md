...
**Полный путь:** `PATCH /content/v2/tag/{id}`
...
<br>Новые данные можно получить в общем [списке](./work-with-products#tag/Yarlyki/paths/~1content~1v2~1tags/get).
...
|---|---|---|---|---|
| `id` | path | integer; пример: `1` | да | Числовой ID ярлыка |
...
- `color` — string; пример: `D1CFD7`. Цвет ярлыка
- `name` — string; пример: `Sale`. Имя ярлыка
