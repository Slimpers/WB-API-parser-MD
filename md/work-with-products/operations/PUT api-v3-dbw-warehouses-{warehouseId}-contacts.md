...
**Полный путь:** `PUT /api/v3/dbw/warehouses/{warehouseId}/contacts`
...
- `contacts` — array<object>
  - *(элементы)*
    - `comment` — string; пример: `Иванов Иван Иванович. Звонить с 10 до 21 часа.`. Комментарий
    - `phone` — string; пример: `+79998887766`. Номер телефона.<br>Поддерживаются коды стран:
